...
export const pages = {
	home: {
		...
		title: 'Home',
		target: null,
		positions: ['footer'] as PagePosition[],
	},
	...
	projects: {
		...
		title: 'Projects',
		target: null,
		positions: ['main', 'offcanvas', 'footer'] as PagePosition[],
	},
	crafts: {
		slug: 'https://crafts.joostramke.com',
		title: 'Crafts',
		target: '_blank',
		positions: ['main', 'offcanvas', 'footer'] as PagePosition[],
	},
	...
	cv: {
		slug: 'https://cv.joostramke.com',
		title: 'CV',
		target: '_blank',
		positions: ['footer', 'offcanvas'] as PagePosition[],
	},
	...
	colophon: {
		...
		title: 'Colophon',
		target: null,
		positions: ['legals'] as PagePosition[],
	},
	privacy: {
		slug: '/privacy',
		title: 'Privacy',
	...
	twitter: {
		slug: 'https://twitter.com/jstrmk_',
		title: 'x.com',
		target: '_blank',
		positions: ['social'] as PagePosition[],
	},
	github: {
		slug: 'https://github.com/jramke',
		title: 'Github',
		target: '_blank',
		positions: ['social'] as PagePosition[],
	},
	instagram: {
		slug: 'https://instagram.com/jstrmk',
		title: 'Instagram',
		target: '_blank',
		positions: ['social'] as PagePosition[],
	},
	email: {
		slug: 'mailto:hey@joostramke.com',
		title: 'Email',
		target: null,
		positions: ['social'] as PagePosition[],
	},
