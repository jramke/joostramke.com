...
<section>
    <div class="content-grid prose">
        <h1>Projects</h1>
        <p>
            Some ideas I transformed into nice digital experiences. An overview over my recent projects i did in the last years. You can find more work at <a href="https://brainworxx.de" target="_blank">Brainworxx</a> and explore what we did as team so far.
        </p>
